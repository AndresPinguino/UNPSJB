...
& q_u = 1.2 \cdot D + 1.6 \cdot L = 1.2 \cdot 858 \frac{Kg}{m^2} + 1.6 \cdot 400 \frac{Kg}{m^2} = 1669.6 \frac{Kg}{m^2} \Rightarrow \framebox{$1.66 \frac{t}{m^2}$}\\
& q_u = 1.4 \cdot D = 1.4 \cdot 858 \frac{Kg}{m^2} = 1201.2 \frac{Kg}{m^2} \Rightarrow 1.20 \frac{t}{m^2}\\
& Mu_x = \frac{q_u \cdot (l_{menor})^2}{m_{x}} = \frac{1.66 \frac{t}{m^2} \cdot (3.60m)^2}{14.64} \framebox{$1.46 \frac{t \cdot m}{m}$}\\
& Mu_y = \frac{q_u \cdot (l_{menor})^2}{m_{y}} = \frac{1.66 \frac{t}{m^2} \cdot (3.60m)^2}{33.56} \framebox{$0.64 \frac{t \cdot m}{m}$}
\end{align*}
\newpage
